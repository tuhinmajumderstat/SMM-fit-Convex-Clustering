...
n <- 1000
modelfit1 <- function(iter)modelfit_weylandt(iter,R=R,n=n,m=3,group_id=group_id)
...
saveRDS(results_list,"JCGS_Model2_weylandt_n_1000.rds")
...
n <- 2000
modelfit2 <- function(iter)modelfit_weylandt(iter,R=R,n=n,m=3,group_id=group_id)
...
saveRDS(results_list,"JCGS_Model2_weylandt_n_2000.rds")
